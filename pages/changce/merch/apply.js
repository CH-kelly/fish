...
Page({
    ...
    bindPickerChange: function(e) {     //商户分类
        ...
        console.log(index,cateName,cateId);
        this.setData({
            index: index,
            cateName:cateName,
            cateId:cateId
    ...
    getData: function() {
        var t = this;
        a.get("changce/merch/apply",{type:0}, function(e) {
            if(e.error == 0){
           ...
           if (!e.data.license){
            ...
            if (!e.data.license){
             ...
             if (!e.data.desc){
               ...
               return void i.toast(e, "请输入店铺简介"); 
           }else{
               if(e.data.descNumber < 40 ){
                   e.setData({
                       errmsg:'店铺简介需要大于40个字符'
                   })
                   return void i.toast(e, "店铺简介需要大于40个字符"); 
               }
           }
           if (!e.data.banner){
            ...
            if (!e.data.agreen){
                 e.setData({error1:0,error2:0,error3:0,error4:0,error5:0,error6:0,error7:0,error8:0,error9:0,error10:1}); 
                return void i.toast(e, "请同意商户入驻规则"); 
            }
